...
window.EditorUi = function(editor, container, lightbox)
{
    ...
    this.actions = new window.Actions(this);
...
{
    // Creates menubar
    this.menubar = (this.editor.chromeless) ? null : null;
    // 顶部操作栏
...
EditorUi.prototype.showLinkDialog = function(value, btnLabel, fn)
{
    ...
    this.showDialog(dlg.container, 430, 90, true, true);
    dlg.init();
};
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (let cell of graph.getSelectionCells()) {
                            let shapeName = graph.view.getState(cell).style.shape;
                            if (['menuCell', 'tableCell'].includes(shapeName)) {
                                return false;
                            }
                        }
                        if (keyCode == 37)
