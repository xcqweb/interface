export default {
    ...
    endPos: 'Terminal point',
    flowDirection: 'Flow indication',
    numberRange: 'Numerical range',
    numberShow: 'Numerical display',
    linkAddress: 'Link address',
    chooseWidget: 'Select the component',
    ...
    notAllowBindMultiplyDevice: 'This control does not allow multiple device types to be bound',
    ...
    choosePopup: 'Select popup window',
