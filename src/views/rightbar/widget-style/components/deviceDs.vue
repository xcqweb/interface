...
import {Button,Checkbox,Message,Select,Option, CheckboxGroup,Input, Tooltip} from 'iview'
...
export default{
  ...
  methods: {
    ...
    init() {
      ...
      if(this.bindData && this.bindData.dataSource && (!this.bindData.dataSource.type)) {
