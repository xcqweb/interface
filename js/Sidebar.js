...
/**
 * Adds all palettes 颜色 to the sidebar.
 */
...
//原型初始化
{
 ...
 //    this.addUmlPalette(false);//UML
	...
	// //png IOT平台图片集
	this.addImagePalette('IOT', mxResources.get('IOT'), dir + '/IOT/','.png',
		['t1_cl2_layout',
		't2_cl2_layout',
		'cl2_green',
        'cl2_yellow',
 ...
 //        'Smart20motor' ,
 //        'Speed20reducer' ,
 //        'Stepping20motor-driver20unit.svg'], null,
 //        {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
...
/**
 * Adds the general palette to the sidebar. 基本图形-svg 加载
 */
